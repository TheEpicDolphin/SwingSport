    ...
    private void FixedUpdate()
    {
        if (isGrappled)
        {
            ...
            else if (release)
            {
                ...
                Vector3 releaseForce = Mathf.Min(0.0f, 
                    Mathf.Max(Vector3.Dot(customGravity, directionToHook), -100.0f)) * directionToHook;
            ...
            /* Also apply force to where hook is attached to */
        }
        /*
        if (isGrappled)
        {
